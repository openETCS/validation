...
void Decop_Received_BG_reset_Subfunctions_CheckBGInput_Pkg(
  outC_Decop_Received_BG_Subfunctions_CheckBGInput_Pkg *outC)
{
}

/* Subfunctions_CheckBGInput_Pkg::Decop_Received_BG */
void Decop_Received_BG_Subfunctions_CheckBGInput_Pkg(
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** Decop_Received_BG_Subfunctions_CheckBGInput_Pkg.c
** Generation date: 2015-06-12T21:21:30
*************************************************************$ */
