...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P005_sections_array_flat_T_TM /* TM_lib_internal::C_P005_flatten_sections::Flattened */ Flattened;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------  no initialization variables  ----------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P005_fs_flatten_array_TM_lib_internal /* 2 */ _1_Context_2[231];
  outC_C_P005_fs_struct_to_array_TM_lib_internal /* 2 */ Context_2[33];
  /* ----------------- no clocks of observable data ------------------ */
  /* -------------------- (-debug) no assertions  -------------------- */
  /* ------------------- (-debug) local variables -------------------- */
  P005_sections_array_flat_T_TM /* TM_lib_internal::C_P005_flatten_sections::_L76 */ _L76;
  P005_OBU_sectionlist_int_T_TM /* TM_lib_internal::C_P005_flatten_sections::_L75 */ _L75;
  array_int_7_33 /* TM_lib_internal::C_P005_flatten_sections::_L74 */ _L74;
  P005_sections_array_flat_T_TM /* TM_lib_internal::C_P005_flatten_sections::_L78 */ _L78;
  array_int_7_33_231 /* TM_lib_internal::C_P005_flatten_sections::_L80 */ _L80;
