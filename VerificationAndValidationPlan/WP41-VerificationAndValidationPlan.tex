...
\texttt{Contributors to this chapter:
  ...
  \item[SQS] Contributions to all ssections
...
\item[Code---Verification (3e):] verification depends on code
  generation method, unit test requirements have to be met, then code integration
...
\texttt{Contributions to this chapter
  ...
  \item[U Bremen] RT Tester application
  \item[Siemens] application story
  \item[SQS] tbd
  \item[CEA] Application story
  \item[All4Tec] tbd
  \end{description}
}
