...
key initial () {
	...
	return store (make_value (0, 0, 0, 1, 1, 6, 1, 110, 110, 0, 4.0, 0, 120, 0, 1, 0, 1, 0, 0, 0, 0, 7.5, 0, 1, 5.5, 1, 0, 0, 1, 3, 0, 1, 1, 0, 1, 0));
}
