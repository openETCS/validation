...
3.x Use cases are not yet real in operation

Results see presentation.

\Q{}{Which operating Rules are we talking about?}
\A{}{Betuweroute \& VDE 8 are proposed within the FPP}
...
\C{S.Baro \& P.-F. Jauquet}Decision: Model as much as possible /all of the OBU and then try to do the whole safety activities on a small part of the subset.
For which the tool chain a nd process are compliant.

\C{P.-F. Jauquet}WP3 takes a small part of the model out of the tool evaluation project to evaluate the safety model.

Focus: Only the semi-final model should be safety certifiable.


Decision:Safety proof will be done on semi- formal model
Decision: Code Generation taking out of safety strategy
 No T3 Code generator in focus
...
Pie diagrams in green and red within the model says: Real time property of the executable code can probably not mathematically verified.
& F
& Jens Gerlach 
\\\hline
