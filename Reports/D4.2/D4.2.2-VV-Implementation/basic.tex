...
\fxfatal{Ist "valid" ein Begriff von K+R? Oder von Frama-C? (Im
letzteren Fall hier erkl\"aren.)}
...
bit $k = i \% 8$ \fxfatal{Die vorige Fassung, $k = i \pmod{8}$,
bedeutet m.E. soviel wie $k \equiv_{\mod 8} i$, w\"ahrend hier eine
Vorschrift zur Berechnung von $k$ aus $i$ gemeint ist.} within this byte.
