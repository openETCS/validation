...
\framacwp support this separation of specification of and implementation.
...
\framacwp can indeed verify that for the first three calls 
...
arguments, then \framacwp can exploit the specification of 
