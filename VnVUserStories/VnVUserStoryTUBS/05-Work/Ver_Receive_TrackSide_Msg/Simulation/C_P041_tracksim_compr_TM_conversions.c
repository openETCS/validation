...
void C_P041_tracksim_compr_init_TM_conversions(
  outC_C_P041_tracksim_compr_TM_conversions *outC)
{
  ...
  outC->_L387 = 0;
  for (i = 0; i < 33; i++) {
    outC->_L385[i].M_LEVELTR = 0;
    outC->_L385[i].NID_NTC = 0;
    outC->_L385[i].L_ACKLEVELTR = 0;
  }
  for (i1 = 0; i1 < 1; i1++) {
    outC->_L386[i1].M_LEVELTR = 0;
    outC->_L386[i1].NID_NTC = 0;
    outC->_L386[i1].L_ACKLEVELTR = 0;
  }
  for (i2 = 0; i2 < 105; i2++) {
    outC->_L384[i2] = 0;
  }
  ...
  outC->_L375.M_LEVELTR = 0;
  outC->_L375.NID_NTC = 0;
  outC->_L375.L_ACKLEVELTR = 0;
  for (i7 = 0; i7 < 5; i7++) {
    outC->_L373[i7] = 0;
  }
  for (i8 = 0; i8 < 32; i8++) {
    outC->_L368[i8].M_LEVELTR = 0;
    outC->_L368[i8].NID_NTC = 0;
    outC->_L368[i8].L_ACKLEVELTR = 0;
  }
  outC->_L369 = 0;
  outC->_L370 = 0;
  outC->_L371 = 0;
  ...
  outC->_L1.L_PACKET = 0;
  outC->_L1.Q_SCALE = 0;
  outC->_L1.D_LEVELTR = 0;
  outC->_L1.M_LEVELTR = 0;
  outC->_L1.NID_NTC = 0;
  outC->_L1.L_ACKLEVELTR = 0;
  outC->_L1.N_ITER = 0;
  for (i10 = 0; i10 < 32; i10++) {
    outC->_L1.SECTIONS[i10].M_LEVELTR = 0;
    outC->_L1.SECTIONS[i10].NID_NTC = 0;
    outC->_L1.SECTIONS[i10].L_ACKLEVELTR = 0;
  }
  outC->p_size = 0;
  ...
  /* 1 */ C_P041_flatten_sections_init_TM_lib_internal(&outC->Context_1);
}
  ...
  outC_C_P041_tracksim_compr_TM_conversions *outC)
{
  ...
  /* 1 */ C_P041_flatten_sections_reset_TM_lib_internal(&outC->Context_1);
}
  ...
  outC_C_P041_tracksim_compr_TM_conversions *outC)
{
  ...
  /* pow */ for (i1 = 0; i1 < 1; i1++) {
    kcg_copy_P041_section_int_T_TM(&outC->_L386[i1], &outC->_L375);
  }
  kcg_copy_P041_trackide_sectionlist_T_TM(&outC->_L368, &outC->_L1.SECTIONS);
  kcg_copy_array_10404(&outC->_L385[0], &outC->_L386);
  kcg_copy_P041_trackide_sectionlist_T_TM(&outC->_L385[1], &outC->_L368);
  /* 1 */
  C_P041_flatten_sections_TM_lib_internal(&outC->_L385, &outC->Context_1);
