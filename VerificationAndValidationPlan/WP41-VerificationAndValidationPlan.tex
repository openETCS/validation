...
\\
00.08 & 01.08.2013 & H. Hungar & Streamlining, replacing placeholders
by text
\\
\hline
\end{tabular}
...
respect is of course the interface to th safety consideration and the
contribution of V\&V to the safety case.

This means that the contribution of
all activities to a complete verification and validation shall be
defined.
...
Validation, according to the standard, starts after SW/HW integration. Sketch
...
The project will only perform part of the development, and thus
...
describe such ``user stories'' of verifiers and validators, i.e., it
