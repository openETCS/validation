...
void Consistency_NomCheck_Track_BG_reset_Subfunctions_CheckBGInput_Pkg(
  outC_Consistency_NomCheck_Track_BG_Subfunctions_CheckBGInput_Pkg *outC)
{
  ...
  /* 4 */ CAST_Int_to_N_PIG_reset_TM_conversions(&outC->Context_4);
...
void Consistency_NomCheck_Track_BG_Subfunctions_CheckBGInput_Pkg(
  ...
  outC_Consistency_NomCheck_Track_BG_Subfunctions_CheckBGInput_Pkg *outC)
{
  ...
  RadioMetadata_T_Common_Types_Pkg _4_noname;
  T_internal_Type_Obu_BasicTypes_Pkg _5_noname;
  OdometryLocations_T_Obu_BasicTypes_Pkg _6_noname;
  OdometrySpeeds_T_Obu_BasicTypes_Pkg _7_noname;
  A_internal_Type_Obu_BasicTypes_Pkg _8_noname;
  odoMotionState_T_Obu_BasicTypes_Pkg _9_noname;
  odoMotionDirection_T_Obu_BasicTypes_Pkg _10_noname;
  ...
  outC->_L366 = 1;
  outC->_L365 = outC->_L329 - outC->_L366;
  /* 4 */ CAST_Int_to_N_PIG_TM_conversions(outC->_L365, &outC->Context_4);
  outC->_L370 = outC->Context_4.n_pig;
  outC->_L372 = outC->_L203 == outC->_L370;
  ...
  outC->_L364 = outC->_L330 | outC->_L372;
  outC->_L367 = !outC->_L364;
  ...
  kcg_copy_LocWithInAcc_T_Obu_BasicTypes_Pkg(&outC->_L363, &outC->locinacc);
  kcg_copy_LocWithInAcc_T_Obu_BasicTypes_Pkg(&_11_noname, &outC->_L215);
  _10_noname = outC->_L214;
  _9_noname = outC->_L213;
  _8_noname = outC->_L212;
  kcg_copy_OdometrySpeeds_T_Obu_BasicTypes_Pkg(&_7_noname, &outC->_L211);
  kcg_copy_OdometryLocations_T_Obu_BasicTypes_Pkg(&_6_noname, &outC->_L210);
  _5_noname = outC->_L209;
  kcg_copy_RadioMetadata_T_Common_Types_Pkg(&_4_noname, &outC->_L219);
  kcg_copy_Radio_TrackTrain_Header_T_Radio_Types_Pkg(&_3_noname, &outC->_L218);
  _2_noname = outC->_L217;
  outC->Warning_unexspected_Balise = outC->_L367;
  outC->_L331 = outC->_L364 & outC->_L229;
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** Consistency_NomCheck_Track_BG_Subfunctions_CheckBGInput_Pkg.c
** Generation date: 2015-06-12T21:21:30
*************************************************************$ */
