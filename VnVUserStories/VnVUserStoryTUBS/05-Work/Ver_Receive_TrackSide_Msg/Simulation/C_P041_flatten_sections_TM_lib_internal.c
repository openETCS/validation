  ...
  outC_C_P041_flatten_sections_TM_lib_internal *outC)
{
  ...
  for (i6 = 0; i6 < 33; i6++) {
    outC->_L75[i6].M_LEVELTR = 0;
    outC->_L75[i6].NID_NTC = 0;
    outC->_L75[i6].L_ACKLEVELTR = 0;
  }
  for (i7 = 0; i7 < 99; i7++) {
    outC->_L76[i7] = 0;
  }
  ...
  for (i10 = 0; i10 < 99; i10++) {
    /* 1 */
    C_P041_fs_flatten_array_init_TM_lib_internal(&outC->_1_Context_1[i10]);
  }
  for (i9 = 0; i9 < 33; i9++) {
    /* 1 */
    C_P041_fs_struct_to_array_init_TM_lib_internal(&outC->Context_1[i9]);
  }
}
  ...
  outC_C_P041_flatten_sections_TM_lib_internal *outC)
{
  ...
  for (i1 = 0; i1 < 99; i1++) {
    /* 1 */
    C_P041_fs_flatten_array_reset_TM_lib_internal(&outC->_1_Context_1[i1]);
  }
  for (i = 0; i < 33; i++) {
    /* 1 */
  ...
  outC_C_P041_flatten_sections_TM_lib_internal *outC)
{
  kcg_int i2;
  kcg_int i1;
  /* TM_lib_internal::C_P041_flatten_sections */ P041_sections_array_flat_T_TM acc;
  kcg_int i;
