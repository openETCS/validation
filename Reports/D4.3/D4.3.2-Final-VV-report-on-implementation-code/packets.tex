...
This functionality is ensured by the conjunction of the \inl{UpperBitsNotSet(uint64_t, uint8_t)} predicate,
...
function of \inl{AdhesionFactor}. The contract ensures that the function's result matches the evaluation
