...
of the behaviors \inl{normal_case} and \inl{bit_sequence_too_long}.
...
\inl{normal_case}, \inl{bit_sequence_too_long}, and \inl{value_too_big}.
...
The reasons for this modifications are similar to those of \peek
(cf.~Section~\ref{sec:peek-loop-invariants}).
...
\item Most shift operations were rewritten as divisions\slash multiplications
      ...
      that we do not have to deal with aliasing issue between this array
