...
void Test_Balise_Sent_P072_init_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises(
  outC_Test_Balise_Sent_P072_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises *outC)
{
  ...
  /* 1 */
  Test_BalisePackets_P072_init_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Packets(
    &outC->_1_Context_1);
  /* 1 */
...
void Test_Balise_Sent_P072_reset_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises(
  outC_Test_Balise_Sent_P072_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises *outC)
{
  /* 1 */
  Test_BalisePackets_P072_reset_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Packets(
    &outC->_1_Context_1);
  /* 1 */
...
void Test_Balise_Sent_P072_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises(
  ...
  outC_Test_Balise_Sent_P072_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises *outC)
{
  /* UNISIG_Validation_Scenarios::Test_Track_Elements::Test_Balises::Test_Balise_Sent_P072 */ B_data_internal_T_UNISIG_Validation_Scenarios_test_InfraLibInt op_call;
  ...
  kcg_copy_B_data_internal_T_UNISIG_Validation_Scenarios_test_InfraLibInt(
    &outC->_L5,
    B_data_in);
  /* ck_Test_Balise_Sent_P072 */ if (outC->ck_every) {
    /* 1 */
    Test_BalisePackets_P072_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Packets(
      &outC->_L23,
      &outC->_L5,
      &outC->_1_Context_1);
    kcg_copy_B_data_internal_T_UNISIG_Validation_Scenarios_test_InfraLibInt(
...
/* $**************** KCG Version 6.4 (build i21) ****************
** Test_Balise_Sent_P072_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises.c
** Generation date: 2015-09-16T19:37:11
*************************************************************$ */
