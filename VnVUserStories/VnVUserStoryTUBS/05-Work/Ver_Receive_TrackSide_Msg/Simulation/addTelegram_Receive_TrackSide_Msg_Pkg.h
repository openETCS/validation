...
typedef struct {
  ...
  outC_setIntervalBGPosition_Receive_TrackSide_Msg_Pkg /* 1 */ _1_Context_1;
  outC_setCoordinateSystemPosition_Receive_TrackSide_Msg_Pkg /* 1 */ Context_1;
  ...
  TelegramArray_T_BG_Types_Pkg /* Receive_TrackSide_Msg_Pkg::addTelegram::IfBlock1::then::_L36 */ _L36_IfBlock1;
  kcg_int /* Receive_TrackSide_Msg_Pkg::addTelegram::IfBlock1::then::_L35 */ _L35_IfBlock1;
  TelegramArray_T_BG_Types_Pkg /* Receive_TrackSide_Msg_Pkg::addTelegram::IfBlock1::then::_L37 */ _L37_IfBlock1;
  ...
  TelegramArray_T_BG_Types_Pkg /* Receive_TrackSide_Msg_Pkg::addTelegram::IfBlock1::else::_L16 */ _L16_IfBlock1;
  Telegram_T_BG_Types_Pkg /* Receive_TrackSide_Msg_Pkg::addTelegram::IfBlock1::else::_L17 */ _L174_IfBlock1;
  TelegramArray_T_BG_Types_Pkg /* Receive_TrackSide_Msg_Pkg::addTelegram::IfBlock1::else::_L15 */ _L155_IfBlock1;
