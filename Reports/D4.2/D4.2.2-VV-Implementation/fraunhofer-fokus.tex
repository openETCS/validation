...
\subsubsection{Remarks on the Original Implementation}
...
Interestingly, it also adds another unnecessary casts to \inl{uint8_t}.
...
\subsubsection{A First Analysis with \framac}
