...
void C_P045_compr_onboard_reset_TM_conversions(
  outC_C_P045_compr_onboard_TM_conversions *outC)
{
  /* 1 */ CAST_Int_to_NID_MN_reset_TM_conversions(&outC->Context_1);
}
  ...
  outC_C_P045_compr_onboard_TM_conversions *outC)
{
  ...
  /* 1 */ CAST_Int_to_NID_MN_TM_conversions(outC->_L25, &outC->Context_1);
  outC->_L4 = outC->Context_1.nid_mn;
  outC->_L10.valid = outC->_L22;
  outC->_L10.q_dir = outC->_L11;
  outC->_L10.nid_mn = outC->_L4;
