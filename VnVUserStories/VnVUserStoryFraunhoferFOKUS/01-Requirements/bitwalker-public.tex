...
\fxfatal{The functions \peekfinish and \pokefinish have the same specification. -> redundant code\\
However the return value of \peek and respectively \peeknext does not match the return value of \peekfinish.}
