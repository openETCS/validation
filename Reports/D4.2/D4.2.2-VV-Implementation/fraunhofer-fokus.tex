...
This also the reason why we show the informal specification
before the implementation although they were developed the other way round.
...
One can interpret this design decision as an attempt
to increase the robustness of the function against illegal values.
