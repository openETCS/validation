  ...
  outC_Send_P041_MessageLibBaseline2 *outC)
{
  ...
  outC->_L4.L_PACKET = 0;
  outC->_L4.Q_SCALE = 0;
  outC->_L4.D_LEVELTR = 0;
  outC->_L4.M_LEVELTR = 0;
  outC->_L4.NID_NTC = 0;
  outC->_L4.L_ACKLEVELTR = 0;
  outC->_L4.N_ITER = 0;
  for (i2 = 0; i2 < 32; i2++) {
    outC->_L4.SECTIONS[i2].M_LEVELTR = 0;
    outC->_L4.SECTIONS[i2].NID_NTC = 0;
    outC->_L4.SECTIONS[i2].L_ACKLEVELTR = 0;
  }
  for (i3 = 0; i3 < 30; i3++) {
  ...
  /* 1 */ Write_P041_init_TM_trackside(&outC->Context_1);
}
...
void Send_P041_MessageLibBaseline2(
  ...
  outC_Send_P041_MessageLibBaseline2 *outC)
{
  /* MessageLibBaseline2::Send_P041 */ CompressedPackets_T_Common_Types_Pkg op_call;
  /* MessageLibBaseline2::Send_P041 */ kcg_bool _1_op_call;
  kcg_bool noname;
