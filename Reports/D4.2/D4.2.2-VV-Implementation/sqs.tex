...
Below table provide information regarding standard functional metrics such as cyclomatic complexity and others.
...
\item 19.3 (req): The '\#include' directive shall be followed by either a <filename> or a <filename> sequence.
