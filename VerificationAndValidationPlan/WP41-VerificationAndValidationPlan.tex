...
{\footnotesize\sffamily\centering
  \begin{longtable}{||p{.15\textwidth}|p{.4\textwidth}|p{.4\textwidth}||}
    ...
    \begin{description}
    \item[a)]  traceability of requirements to the design or other objects which fulfil them, 
    \item[b)]  traceability of design objects to the implementation objects which instantiate them.
    \item[c)]  traceability  of  requirements  and  design  objects  to  the  tests  (component,  integration,  overall  test)  and analyses that verify them.  
    \end{description}
