...
\section{Informal Specifications of  \peek and \poke}
\label{sec:informal-specification-peek-poke}
...
\section{Informal Specifications of the struct-functions}
\label{sec:informal-specification-stuct-functions}


In this section we examine all functions that uses the struct  \locals, whose signature is shown below.
The record combines all important values to peek or to poke  sequences in a bit stream.
...
\paragraph{Description}
\begin{itemize}
        \item \inl{Bitstream} points to a array that provides the bit stream.
        \item \inl{Length} is the length of array containing the bit stream
        \item \inl{CurrentBitposition}  is the index where the bit sequence starts
\end{itemize}


\subsection{Informal Specification of \peeknext}
\label{sec:informal-specification-peek-next}
...
\subsection{Informal Specification of \peekfinish}
\label{sec:informal-specification-peek-finish}
...
\subsection{Informal Specification of \pokenext}
\label{sec:informal-specification-poke-nextnext}
...
\subsection{Informal Specification of \pokefinish}
\label{sec:informal-specification-poke-finish}
...
Section~\ref{sec:informal-specification-peek-poke}.
