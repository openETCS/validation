...
Listing~\ref{fig:abs3a} shows an implementation of \inl{abs_int}
...
one can use an \inl{assigns \\nothing} clause as shown in Listing~\ref{fig:abs3b}.
...
Listing~\ref{fig:abs3c} shows how the \inl{assigns} clause of a
