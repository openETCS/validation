...
void Pack_Received_BG_reset_Subfunctions_CheckBGInput_Pkg(
  outC_Pack_Received_BG_Subfunctions_CheckBGInput_Pkg *outC)
{
}

/* Subfunctions_CheckBGInput_Pkg::Pack_Received_BG */
void Pack_Received_BG_Subfunctions_CheckBGInput_Pkg(
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** Pack_Received_BG_Subfunctions_CheckBGInput_Pkg.c
** Generation date: 2015-06-12T21:21:30
*************************************************************$ */
