...
void InitBG_reset_Subfunctions(outC_InitBG_Subfunctions *outC)
{
  /* 1 */ Pack_Received_BG_reset_Subfunctions(&outC->_1_Context_1);
  /* 1 */ Decop_Track_Msg_reset_Subfunctions(&outC->Context_1);
}

/* Subfunctions::InitBG */
void InitBG_Subfunctions(
  ...
  outC_InitBG_Subfunctions *outC)
{
  ...
  outC->_L226 = init_DirTrain_CheckBGInputChannel_Pkg;
  outC->_L225 = init_DirLrbg_CheckBGInputChannel_Pkg;
  outC->_L224 = locationacc_CheckBGInputChannel_Pkg;
  outC->_L223 = kcg_true;
  /* 1 */ Decop_Track_Msg_Subfunctions(&outC->_L116, &outC->Context_1);
