...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_CAST_Int_to_Q_LINK_TM_conversions /* 1 */ _9_Context_1;
  outC_CAST_Int_to_NID_BG_TM_conversions /* 1 */ _8_Context_1;
  outC_CAST_Int_to_NID_C_TM_conversions /* 1 */ _7_Context_1;
  outC_CAST_Int_to_M_MCOUNT_TM_conversions /* 1 */ _6_Context_1;
  outC_CAST_Int_to_M_DUP_TM_conversions /* 1 */ _5_Context_1;
  outC_CAST_Int_to_N_TOTAL_TM_conversions /* 1 */ _4_Context_1;
  outC_CAST_Int_to_N_PIG_TM_conversions /* 1 */ _3_Context_1;
  outC_CAST_Int_to_Q_MEDIA_TM_conversions /* 1 */ _2_Context_1;
  outC_CAST_Int_to_M_VERSION_TM_conversions /* 1 */ _1_Context_1;
  outC_CAST_Int_to_Q_UPDOWN_TM_conversions /* 1 */ Context_1;
