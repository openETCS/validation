...
void TEMPLATE_Balise_modified_init_UNISIG_Validation_Scenarios_test_InfraLibInt(
  outC_TEMPLATE_Balise_modified_UNISIG_Validation_Scenarios_test_InfraLibInt *outC)
{
  ...
  /* 1 */
  No_Balise_Packets_init_UNISIG_Validation_Scenarios_test_InfraLibInt(
    &outC->_1_Context_1);
  /* 1 */
...
void TEMPLATE_Balise_modified_reset_UNISIG_Validation_Scenarios_test_InfraLibInt(
  outC_TEMPLATE_Balise_modified_UNISIG_Validation_Scenarios_test_InfraLibInt *outC)
{
  /* 1 */
  No_Balise_Packets_reset_UNISIG_Validation_Scenarios_test_InfraLibInt(
    &outC->_1_Context_1);
  /* 1 */
...
void TEMPLATE_Balise_modified_UNISIG_Validation_Scenarios_test_InfraLibInt(
  ...
  outC_TEMPLATE_Balise_modified_UNISIG_Validation_Scenarios_test_InfraLibInt *outC)
{
  /* UNISIG_Validation_Scenarios::test_InfraLibInt::TEMPLATE_Balise_modified */ B_data_internal_T_UNISIG_Validation_Scenarios_test_InfraLibInt op_call;
  ...
  kcg_copy_B_data_internal_T_UNISIG_Validation_Scenarios_test_InfraLibInt(
    &outC->_L5,
    B_data_in);
  /* ck_TEMPLATE_Balise_modified */ if (outC->ck_every) {
    /* 1 */
    No_Balise_Packets_UNISIG_Validation_Scenarios_test_InfraLibInt(
      &outC->_L23,
      &outC->_L5,
      &outC->_1_Context_1);
    kcg_copy_B_data_internal_T_UNISIG_Validation_Scenarios_test_InfraLibInt(
...
/* $**************** KCG Version 6.4 (build i21) ****************
** TEMPLATE_Balise_modified_UNISIG_Validation_Scenarios_test_InfraLibInt.c
** Generation date: 2015-09-16T19:37:11
*************************************************************$ */
