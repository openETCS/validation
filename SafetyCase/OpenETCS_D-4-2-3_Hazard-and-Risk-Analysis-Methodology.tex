...
\begin{center}
\textbf{"\§3.5 Management of Radio Communication (MoRC)."}
\end{center}
...
\item Conformity comparison for the MoRC
	...
	\item Conformity comparison regarding Input & Output data between Subset 26 and SysML model
	\end{itemize}
