...
Rationale:  \textcolor{red}{The amount of blank lines in a file can indicate the degree of readability in the file. It indicates the author indended his work to be human consumable.}
...
Rationale: \textcolor{red}{This condition indicates a noop or stubbed out function with no operational code.Many code generators create such noop functions which contribute to code bloat and unnecessary resource utilization.}
...
Rationale: \textcolor{red}{A function block should retain a preceeding comment block describing the purpose, parameters, returns and algorithms.}
    \\
    \hline
...
Rationale: \textcolor{red}{A class block should retain a preceeding comment block describing the purpose, and algorithms.}
 & \textbf{Quality Notice No. 53}
 
Emit a quality notice when there is no comment before a struct block. 

Rationale: \textcolor{red}{A struct block should retain a preceeding comment block describing the data and purpose.}
    \\
    \hline
...
RSM has been customized to obtain the below metrics and analysis and the correspondient reports that are available into the \href{https://github.com/openETCS/validation/tree/master/VnVUserStories/VnVUserStorySQS/04-Results}{[VnVUserStories folder]}

\begin{itemize}
\item Project Functional Metrics and Analisys
...
\end{itemize}
\item \textbf{Preprocessinf directives}
\begin{itemize}
