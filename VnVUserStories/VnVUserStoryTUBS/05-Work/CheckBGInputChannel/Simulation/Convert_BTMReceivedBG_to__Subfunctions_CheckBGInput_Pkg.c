...
void Convert_BTMReceivedBG_to__reset_Subfunctions_CheckBGInput_Pkg(
...
void Convert_BTMReceivedBG_to__Subfunctions_CheckBGInput_Pkg(
  ...
  outC_Convert_BTMReceivedBG_to__Subfunctions_CheckBGInput_Pkg *outC)
{
  ...
  outC->_L24.o_nominal = outC->_L21;
  outC->_L24.o_min = outC->_L22;
  outC->_L24.o_max = outC->_L23;
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** Convert_BTMReceivedBG_to__Subfunctions_CheckBGInput_Pkg.c
** Generation date: 2015-06-12T21:21:30
*************************************************************$ */
