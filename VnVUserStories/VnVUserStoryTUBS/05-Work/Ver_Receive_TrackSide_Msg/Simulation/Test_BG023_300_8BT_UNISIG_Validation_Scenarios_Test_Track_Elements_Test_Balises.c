...
void Test_BG023_300_8BT_init_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises(
  outC_Test_BG023_300_8BT_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises *outC)
{
  ...
  Balise_Group_Close_init_UNISIG_Validation_Scenarios_test_InfraLibInt(
    &outC->_3_Context_1);
  /* 1 */
  Test_Balise_Sent_P072_short_init_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises(
    &outC->_2_Context_1);
  /* 3 */
...
void Test_BG023_300_8BT_reset_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises(
  outC_Test_BG023_300_8BT_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises *outC)
{
  /* 1 */
  Balise_Group_Close_reset_UNISIG_Validation_Scenarios_test_InfraLibInt(
    &outC->_3_Context_1);
  /* 1 */
  Test_Balise_Sent_P072_short_reset_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises(
    &outC->_2_Context_1);
  /* 3 */
...
void Test_BG023_300_8BT_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises(
  ...
  outC_Test_BG023_300_8BT_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises *outC)
{
  ...
  TEMPLATE_Balise_modified_UNISIG_Validation_Scenarios_test_InfraLibInt(
    ...
    (BaliseTelegramHeader_int_T_TM *)
      &test_BG023_header_B0of7_nlink_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises,
    outC->_L20,
    &outC->Context_4);
  kcg_copy_B_data_internal_T_UNISIG_Validation_Scenarios_test_InfraLibInt(
    &outC->_L8,
    &outC->Context_4.B_data_out);
  outC->_L21 = 1;
  /* 5 */
  TEMPLATE_Balise_modified_UNISIG_Validation_Scenarios_test_InfraLibInt(
    &outC->_L8,
    (BaliseTelegramHeader_int_T_TM *)
      &test_BG023_header_B1of7_nlink_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises,
    outC->_L21,
    &outC->Context_5);
  kcg_copy_B_data_internal_T_UNISIG_Validation_Scenarios_test_InfraLibInt(
    &outC->_L7,
  ...
  TEMPLATE_Balise_modified_UNISIG_Validation_Scenarios_test_InfraLibInt(
    &outC->_L7,
    (BaliseTelegramHeader_int_T_TM *)
      &test_BG023_header_B2of7_nlink_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises,
    outC->_L22,
    &outC->Context_6);
  kcg_copy_B_data_internal_T_UNISIG_Validation_Scenarios_test_InfraLibInt(
    &outC->_L6,
  ...
  TEMPLATE_Balise_modified_UNISIG_Validation_Scenarios_test_InfraLibInt(
    &outC->_L6,
    (BaliseTelegramHeader_int_T_TM *)
      &test_BG023_header_B3of7_nlink_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises,
    outC->_L23,
    &outC->_1_Context_1);
  kcg_copy_B_data_internal_T_UNISIG_Validation_Scenarios_test_InfraLibInt(
    &outC->_L5,
  ...
  TEMPLATE_Balise_modified_UNISIG_Validation_Scenarios_test_InfraLibInt(
    &outC->_L5,
    (BaliseTelegramHeader_int_T_TM *)
      &test_BG023_header_B4of7_nlink_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises,
    outC->_L24,
    &outC->Context_7);
  kcg_copy_B_data_internal_T_UNISIG_Validation_Scenarios_test_InfraLibInt(
    &outC->_L4,
  ...
  TEMPLATE_Balise_modified_UNISIG_Validation_Scenarios_test_InfraLibInt(
    &outC->_L4,
    (BaliseTelegramHeader_int_T_TM *)
      &test_BG023_header_B5of7_nlink_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises,
    outC->_L25,
    &outC->Context_2);
  kcg_copy_B_data_internal_T_UNISIG_Validation_Scenarios_test_InfraLibInt(
    &outC->_L3,
  ...
  TEMPLATE_Balise_modified_UNISIG_Validation_Scenarios_test_InfraLibInt(
    &outC->_L3,
    (BaliseTelegramHeader_int_T_TM *)
      &test_BG023_header_B6of7_nlink_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises,
    outC->_L26,
    &outC->Context_3);
  kcg_copy_B_data_internal_T_UNISIG_Validation_Scenarios_test_InfraLibInt(
    &outC->_L2,
  ...
  outC->_L27 = 7;
  /* 1 */
  Test_Balise_Sent_P072_short_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises(
    &outC->_L2,
    (BaliseTelegramHeader_int_T_TM *)
      &test_BG023_header_B7of7_nlink_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises,
    outC->_L27,
    &outC->_2_Context_1);
  kcg_copy_B_data_internal_T_UNISIG_Validation_Scenarios_test_InfraLibInt(
    &outC->_L1,
...
/* $**************** KCG Version 6.4 (build i21) ****************
** Test_BG023_300_8BT_UNISIG_Validation_Scenarios_Test_Track_Elements_Test_Balises.c
** Generation date: 2015-09-16T19:37:12
*************************************************************$ */
