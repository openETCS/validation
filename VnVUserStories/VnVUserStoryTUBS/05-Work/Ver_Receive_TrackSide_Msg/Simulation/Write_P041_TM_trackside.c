...
void Write_P041_init_TM_trackside(outC_Write_P041_TM_trackside *outC)
{
  kcg_int i11;
  kcg_int i10;
  kcg_int i9;
  ...
  outC->_L1.N_ITER = 0;
  for (i9 = 0; i9 < 32; i9++) {
    outC->_L1.SECTIONS[i9].M_LEVELTR = 0;
    outC->_L1.SECTIONS[i9].NID_NTC = 0;
    outC->_L1.SECTIONS[i9].L_ACKLEVELTR = 0;
  }
  ...
  /* 1 */ C_P041_tracksim_compr_init_TM_conversions(&outC->Context_1);
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void Write_P041_reset_TM_trackside(outC_Write_P041_TM_trackside *outC)
{
  ...
  /* 1 */ C_P041_tracksim_compr_reset_TM_conversions(&outC->Context_1);
}
