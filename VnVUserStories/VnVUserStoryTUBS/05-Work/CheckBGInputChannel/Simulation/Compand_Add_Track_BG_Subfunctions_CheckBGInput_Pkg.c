...
void Compand_Add_Track_BG_reset_Subfunctions_CheckBGInput_Pkg(
...
void Compand_Add_Track_BG_Subfunctions_CheckBGInput_Pkg(
  ...
  outC_Compand_Add_Track_BG_Subfunctions_CheckBGInput_Pkg *outC)
{
  ...
  kcg_copy_checkedBG_CheckBGInputChannel_Pkg(&outC->_L5, Stored_BG);
  kcg_copy_OdometryLocations_T_Obu_BasicTypes_Pkg(
    &outC->_L70,
    &outC->_L5.LocDiff);
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** Compand_Add_Track_BG_Subfunctions_CheckBGInput_Pkg.c
** Generation date: 2015-06-12T21:21:30
*************************************************************$ */
