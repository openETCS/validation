...
void Balise_Group_367_reset_AmsterdamUtrechtL1_Sheet06_Bijlmer(
  outC_Balise_Group_367_AmsterdamUtrechtL1_Sheet06_Bijlmer *outC)
{
  /* 1 */ Balise_Group_Close_reset_InfraLib(&outC->_3_Context_1);
  /* 1 */
  Balise_367_0_reset_AmsterdamUtrechtL1_Sheet06_Bijlmer(&outC->_2_Context_1);
  /* 1 */
  Balise_367_1_reset_AmsterdamUtrechtL1_Sheet06_Bijlmer(&outC->_1_Context_1);
  /* 1 */ Balise_Group_Init_reset_InfraLib(&outC->Context_1);
}

/* AmsterdamUtrechtL1::Sheet06_Bijlmer::Balise_Group_367 */
void Balise_Group_367_AmsterdamUtrechtL1_Sheet06_Bijlmer(
  ...
  outC_Balise_Group_367_AmsterdamUtrechtL1_Sheet06_Bijlmer *outC)
{
  ...
  outC->_L20 = 0;
  /* 1 */
  Balise_367_1_AmsterdamUtrechtL1_Sheet06_Bijlmer(
    &outC->_L9,
  ...
  outC->_L21 = 1;
  /* 1 */
  Balise_367_0_AmsterdamUtrechtL1_Sheet06_Bijlmer(
    &outC->_L8,
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** Balise_Group_367_AmsterdamUtrechtL1_Sheet06_Bijlmer.c
** Generation date: 2015-06-12T21:21:30
*************************************************************$ */
