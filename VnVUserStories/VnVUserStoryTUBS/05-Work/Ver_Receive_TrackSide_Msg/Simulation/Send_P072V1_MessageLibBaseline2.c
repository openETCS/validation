...
void Send_P072V1_init_MessageLibBaseline2(
  outC_Send_P072V1_MessageLibBaseline2 *outC)
{
  ...
  outC->_L4.L_PACKET = 0;
  outC->_L4.Q_SCALE = 0;
  outC->_L4.Q_TEXTCLASS = 0;
  outC->_L4.Q_TEXTDISPLAY = 0;
  outC->_L4.D_TEXTDISPLAY_start = 0;
  outC->_L4.M_MODETEXTDISPLAY_start = 0;
  outC->_L4.M_LEVELTEXTDISPLAY_start = 0;
  outC->_L4.NID_NTC_start = 0;
  outC->_L4.L_TEXTDISPLAY_end = 0;
  outC->_L4.T_TEXTDISPLAY_end = 0;
  outC->_L4.M_MODETEXTDISPLAY_end = 0;
  outC->_L4.M_LEVELTEXTDISPLAY_end = 0;
  outC->_L4.NID_NTC_end = 0;
  outC->_L4.Q_TEXTCONFIRM = 0;
  outC->_L4.L_TEXT = 0;
  for (i2 = 0; i2 < 255; i2++) {
    outC->_L4.X_TEXT[i2] = 0;
  }
  for (i3 = 0; i3 < 30; i3++) {
  ...
  /* 1 */ Write_P072V1_init_TM_trackside_baseline2(&outC->Context_1);
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void Send_P072V1_reset_MessageLibBaseline2(
  outC_Send_P072V1_MessageLibBaseline2 *outC)
{
  /* 1 */ Write_P072V1_reset_TM_trackside_baseline2(&outC->Context_1);
}
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

/* MessageLibBaseline2::Send_P072V1 */
void Send_P072V1_MessageLibBaseline2(
  ...
  outC_Send_P072V1_MessageLibBaseline2 *outC)
{
  /* MessageLibBaseline2::Send_P072V1 */ CompressedPackets_T_Common_Types_Pkg op_call;
  /* MessageLibBaseline2::Send_P072V1 */ kcg_bool _1_op_call;
  kcg_bool noname;
  
  kcg_copy_P072V1_trackside_int_T_TM_baseline2(&outC->_L4, P072V1);
  outC->_L5 = outC->_L4.valid;
  outC->ck_every = outC->_L5;
  kcg_copy_CompressedPackets_T_Common_Types_Pkg(&outC->_L3, B_data_in);
  /* ck_Send_P072V1 */ if (outC->ck_every) {
    /* 1 */
...
/* $**************** KCG Version 6.4 (build i21) ****************
** Send_P072V1_MessageLibBaseline2.c
** Generation date: 2015-09-16T19:37:11
*************************************************************$ */
