...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_checkSingleBB_Receive_TrackSide_Msg_Pkg_BaliseSupport /* 1 */ _2_Context_1;
  outC_initCollector_Receive_TrackSide_Msg_Pkg_BaliseSupport /* 1 */ _1_Context_1;
  outC_findTelegram_Receive_TrackSide_Msg_Pkg_BaliseSupport /* 1 */ Context_1;
